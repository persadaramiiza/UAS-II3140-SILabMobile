import svgPaths from "./svg-qm350aasmb";
...
export default function Component8ActiveQuizzes() {
  return (
    <div className="relative size-full" data-name="8 - Active Quizzes">
      <div className="absolute bg-white content-stretch flex flex-col gap-[0.7px] h-[852px] items-start left-0 overflow-clip top-0 w-[393px]" data-name="Finalize SILab Suite Design">
        <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-[393.318px]" data-name="Container">
          <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
            <div className="absolute bg-white content-stretch flex flex-col h-[771.731px] items-start left-0 pb-0 pt-[136.646px] px-[23.992px] top-0 w-[393.318px]" data-name="QuizList">
              <div className="bg-white h-[242.346px] relative rounded-[16px] shrink-0 w-full" data-name="Container">
                <div className="overflow-clip relative rounded-[inherit] size-full">
                  <div className="absolute h-[208.95px] left-[16.7px] top-[16.7px] w-[311.938px]" data-name="Container">
                  ...
                  <div className="absolute bg-[#0f2a71] h-[240.946px] left-[0.7px] rounded-bl-[16px] rounded-tl-[16px] top-[0.7px] w-[3.991px]" data-name="Container" />
                </div>
