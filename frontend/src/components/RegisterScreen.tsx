...
export default function RegisterScreen({ onRegister, onNavigateToLogin }: RegisterScreenProps) {
  ...
  const handleRegister = () => {
    // Simple demo registration - in production would validate and create account
    onRegister();
  };
    ...
    <div className="min-h-full bg-white overflow-y-auto scrollbar-hide relative">
      ...
      <div className="relative px-6 pt-16 pb-8">
        ...
        <button
          ...
          className="absolute top-4 left-6 w-10 h-10 flex items-center justify-center rounded-full hover:bg-[#F5F5F5] transition-colors"
        >
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-[var(--text-secondary)]" style={{ fontSize: '16px' }}>
            Register to access SILab Suite
          </p>
        </div>
        ...
        <div className="bg-white border border-[#E8E8E8] rounded-[16px] p-6 mb-6">
          ...
          <button className="w-full h-12 bg-white border border-[#E8E8E8] rounded-[12px] flex items-center justify-center gap-3 hover:bg-[#F5F5F5] transition-colors">
            ...
            <span style={{ fontSize: '16px', color: '#111' }}>Sign up with Google</span>
          </button>
        </div>
